...
CustomThemePrivate::CustomThemePrivate(CustomTheme *q)
	: q_ptr(q)
{
}

CustomThemePrivate::~CustomThemePrivate()
{
}

QColor CustomThemePrivate::rgba(int r, int g, int b, qreal a) const
{
	QColor color(r, g, b);
	color.setAlphaF(a);
	return color;
...
CustomTheme::CustomTheme(QObject *parent)
	: QObject(parent),
	d_ptr(new CustomThemePrivate(this))
{
...
QColor CustomTheme::getColor(const QString &key) const
{
	Q_D(const CustomTheme);
...
void CustomTheme::setColor(const QString &key, const QColor &color)
{
	Q_D(CustomTheme);
...
void CustomTheme::setColor(const QString &key, Material::Color color)
{
	Q_D(CustomTheme);
...
QIcon CustomTheme::icon(QString category, QString icon)
{
