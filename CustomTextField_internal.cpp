...
CustomTextFieldStateMachine::CustomTextFieldStateMachine(CustomTextField *parent)
...
CustomTextFieldStateMachine::~CustomTextFieldStateMachine()
{
}

void CustomTextFieldStateMachine::setLabel(CustomTextFieldLabel *label)
{
	if (m_label) {
		delete m_label;
	}
...
void CustomTextFieldStateMachine::setupProperties()
{
	if (m_label)
	{
...
CustomTextFieldLabel::CustomTextFieldLabel(CustomTextField *parent)
	: QWidget(parent),
	m_textField(parent),
	m_scale(1),
	m_posX(0),
...
*  \reimp
*/
void CustomTextFieldLabel::paintEvent(QPaintEvent *event)
{
	Q_UNUSED(event)
